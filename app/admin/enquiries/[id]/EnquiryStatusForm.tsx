...
/**
 * Client status form for an enquiry. Calls the server action, then shows a
 * success toast and refreshes the page (so the badge above reflects the new
 * status) — or an error toast if the update failed.
 */
